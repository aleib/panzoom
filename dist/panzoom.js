        ...
        function constrainXY(toX, toY, toScale, panOptions) {
            ...
            if (opts.contain || opts.maxPanRatio) {
                ...
                if (opts.contain === 'inside') {
                    ...
                    var elem_1 = dims.elem, parent_1 = dims.parent;
                    var panHeight = elem_1.height < parent_1.height ? elem_1.height : parent_1.height;
                    var panWidth = elem_1.width < parent_1.width ? elem_1.width : parent_1.width;
                    var minX = (diffHorizontal -
                        dims.elem.margin.left -
                        dims.parent.padding.left -
                        scaledWidth +
